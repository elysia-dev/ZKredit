export default function CheckItem(props) {
  if (props.checked) {
    return (
      <li className="flex space-x-3">
        ...
        <span className="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">{props.name}</span>
      </li>
    )
  }
  ...
  return (
    <li className="flex space-x-3 line-through decoration-gray-500">
      ...
      <span className="text-base font-normal leading-tight text-gray-500">{props.name}</span>
    </li>
  )
}